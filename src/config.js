...
export const ARMORS = {
  ...
  adamantine: { name: 'Adamantine Plate',  reduction: 0.55, speedPenalty: 0,    cost: 50000, requires: 'arcaneLibrary' },
};
...
export const TROOPS = {
  ...
  knight:  { name: 'Knight',  hp: 80,  damage: 15, attackRate: 1.0, speed: 90,  cost: 200, max: 3, requires: 'knightAcademy', width: 32, height: 36, color: '#88c', type: 'melee' },
  ...
  shredder:{ name: 'Shredder',hp: 150, damage: 25, attackRate: 0.8, speed: 40,  cost: 500, max: 1, requires: 'advCombat',     width: 44, height: 40, color: '#aa8', type: 'melee' },
};
...
export const POTIONS = {
  stoneskin: { name: 'Stoneskin Potion', heal: 50, cost: 200, maxCarry: 3, requires: 'wizardTower' },
};
